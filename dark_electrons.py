...
gain_gauss = gauss_nan(gain, sigma=(0,5,5))
...
print(f"ISO {ISO} ; mean {dark_separate.mean():.3f} e-/s; std {dark_separate.std():.3f} e-/s ; RMS {np.sqrt(np.mean(dark_separate**2)):.3f} e-/s")
