...
spectral.plot_monochromator_curves(wavelengths, raw_mean, raw_stds, title=f"{camera.name}: Raw spectral curves", saveto=save_folder/"monochromator_raw_spectra.pdf")
...
spectral.plot_monochromator_curves(wavelengths, calibrated_mean, calibrated_stds, title=f"{camera.name}: Calibrated spectral curves", saveto=save_folder/"monochromator_calibrated_spectra.pdf")
...
spectral.plot_monochromator_curves(wavelengths, normalised_mean, normalised_stds, title=f"{camera.name}: Normalised spectral curves", saveto=save_folder/"monochromator_normalised_spectra.pdf")
...
spectral.plot_monochromator_curves(wavelengths, final_mean, final_stds, title=f"{camera.name}: Combined spectral curves", unit="normalised", saveto=save_folder/"monochromator_final_spectrum.pdf")
...
spectral.plot_monochromator_curves(wavelengths, [SNR], [SNR_err], title=f"{camera.name}: Signal-to-noise ratio", unit="SNR", saveto=save_folder/"monochromator_SNR.pdf")
